...
{   public class SchetsControl : UserControl
    {   private Schets schets;
        ...
        public List<TekenObject> getekendeObjecten = new List<TekenObject>();
        ...
        public virtual void printGetekendeObjecten()
        {
            foreach (TekenObject i in getekendeObjecten)
            {
                Console.Write(i.startpunt);
                Console.Write(", ");
            }
            Console.WriteLine();
        }
