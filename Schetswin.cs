...
namespace SchetsEditor
{
    ...
    {   
        ...
        private void opslaan(object obj, EventArgs ea)
        {
            ...
            opslagdialoog.Filter = "Tekstfiles|*.txt|Alle files|*.*";
            opslagdialoog.Title = "Schets opslaan als...";
        ...
        {
            OpenFileDialog opendialoog = new OpenFileDialog();
            
            opendialoog.Filter = "Tekstfiles|*.txt|Alle files|*.*";
            opendialoog.Title = "Schets openen...";
            if (opendialoog.ShowDialog() == DialogResult.OK)
                this.Close();
        }
